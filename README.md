...
完整步驟（建 Discord bot、systemd 替代方案、指令用法、安全）見 **[docs/deploy.md](docs/deploy.md)**；版本變更、升級遷移、跨校 provider 與 partial-failure 行為見 **[docs/release-notes.md](docs/release-notes.md)**。
