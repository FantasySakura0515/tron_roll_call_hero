...
class TronCliSmokeTest(unittest.TestCase):
    ...
    def test_provider_list_json_command_dispatches(self) -> None:
        ...
        self.assertEqual(result, 0)
        payload = json.loads(outputs[0])
        self.assertEqual({item["key"] for item in payload["providers"]}, {"thu", "fju", "tku", "tronclass", "nsysu", "cyut", "ntou"})
    ...
    def test_provider_list_all_json_includes_fju(self) -> None:
        ...
        self.assertEqual(set(providers), {"thu", "fju", "tku", "tronclass", "nsysu", "cyut", "ntou"})
    ...
    def test_provider_show_json_command_dispatches(self) -> None:
        ...
        self.assertEqual(payload["auth_flow"], "tronclass_form_captcha")
