    ...
    actions = [
        {
            ...
            "label": "Status",
            "category": "safe-read",
            "command_template": "python -m tron_roll_call_hero.tron status --json",
        ...
        },
        {
            ...
            "category": "safe-read",
            "command_template": "python -m tron_roll_call_hero.tron dashboard --json",
            "executes_in_shell": False,
        },
        {
            "id": "qr_preview",
            ...
            "command_template": "python -m tron_roll_call_hero.tron qr paste --json <QR_URL_OR_PAYLOAD>",
            "executes_in_shell": False,
        },
        {
            "id": "webview_preview",
            ...
            "category": "preview-only",
            "command_template": "python -m tron_roll_call_hero.tron webview preview --input cookies.json --json",
            "executes_in_shell": False,
        },
        {
            "id": "release_check",
            "label": "Release Check",
            "category": "safe-read",
            "command_template": "python -m tron_roll_call_hero.tron release-check --json",
            "executes_in_shell": False,
        },
    ]
    return {
