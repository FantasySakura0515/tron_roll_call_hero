...
try:  # pragma: no cover - script execution fallback
    from tron_roll_call_hero.providers import DEFAULT_PROVIDER, get_provider, normalize_provider_config, provider_support_report
    from tron_roll_call_hero.radar_solver import DEFAULT_BOUNDARY_POINTS
    from tron_roll_call_hero.runtime_helpers import normalize_radar_boundary_points
