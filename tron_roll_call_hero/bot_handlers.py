...
try:
    ...
    from tron_roll_call_hero.bot_runtime import BotAuditEvent, BotRuntime, BotRuntimeHandlers
    from tron_roll_call_hero.pending_qr import list_pending_qr
    ...
    def __init__(
        ...
        *,
        ...
        if tron_module is None:
            try:
                from tron_roll_call_hero import runtime_context as tron_module  # pylint: disable=import-outside-toplevel
            except ImportError:  # pragma: no cover - script execution fallback
